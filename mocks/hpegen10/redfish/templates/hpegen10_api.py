...
class hpegen10Collection(Resource):
	def __init__(self):
		self.rb = g.rest_base
		self.config = {
			'@odata.context': self.rb + '$metadata#hpegen10Collection.hpegen10Collection'
			'@odata.id': self.rb + 'hpegen10Collection'
			'@odata.type': '#hpegen10Collection.1.0.0.hpegen10Collection'
